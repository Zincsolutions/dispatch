    ...
    <section className="py-32 bg-[#141414]">
      <div className="max-w-3xl mx-auto px-6 text-center">
        <h2 className="text-3xl sm:text-4xl md:text-[44px] font-extrabold text-white leading-tight tracking-tight mb-6">
          Start building your <span className="gradient-text-dark">AI operations system</span>.
        </h2>
        <p className="text-lg text-white/60 max-w-xl mx-auto mb-10 leading-relaxed">
          Organize your AI knowledge, workflows, agents, and governance in one
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            ...
            onClick={() =>
              track("free_signup_clicked", { plan: "team", cta_location: "bottom_cta" })
            }
